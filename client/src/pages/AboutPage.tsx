  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div className="rounded-[2rem] border border-ink/5 bg-[linear-gradient(135deg,#ffffff_0%,#eef9ff_55%,#fff7fb_100%)] p-8 shadow-soft">
          <p className="text-xs font-bold uppercase tracking-[0.24em] text-ink/45">About us</p>
          <h1 className="mt-3 font-display text-4xl font-semibold leading-tight md:text-5xl">{settings?.aboutTitle ?? "About Siyu Creativity"}</h1>
          <p className="mt-6 whitespace-pre-line text-justify text-base leading-8 text-ink/70 md:text-lg">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {[
            ...
            <div className="rounded-[1.5rem] border border-ink/5 bg-white p-5 shadow-soft" key={item.label}>
