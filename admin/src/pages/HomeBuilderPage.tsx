  ...
  return (
    <section>
      ...
      <form className="mt-5 grid max-w-4xl gap-4 rounded-lg bg-panel p-5 shadow-panel" onSubmit={submit}>
        ...
        <MultiMediaUploadField label="Hero banner carousel images" title="Homepage hero carousel" alt="Homepage hero carousel" value={form.heroImages ?? ""} onChange={(heroImages) => setForm({ ...form, heroImages })} />
